...
_SENTENCE_TEMPLATE = (
    resources.files(__package__).joinpath("example_sentence.txt").read_text(encoding="utf-8")
)
...
def build_sentence_validation_prompt(
    word: str, word_translation: str, source_lang: str, sentence: str
) -> str:
